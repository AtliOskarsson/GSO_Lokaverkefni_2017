...
create table flytjandi(
    ...
    faedingardagur date,
    danardagur date,
    flokkur_ID int,create database if not exists 0202002190_lokaverk;
use 0202002190_lokaverk;
...
insert into lag
(nafn,lengd,texti,flytjandi_ID,diskur_ID)
values
	...
	henni fékk ekkert út skolað.',4,7),
	...
	Kor-ah, Daa-nyah. Kor-ah, Rah-tah-mah.
	Nyo-hah, Kee-lah, Kor-ah, Rah-tah-mah.
	Syahd-ho, Kee-la, Daan-yah, Rah-tah-mah. Kor-ah!',1,6),

	('The Raider´s March',311,'Enginn texti',1,6),

	('Star Wars- Main Theme',351,'enginn texti',1,1),
	('Princess Leia',283,'enginn texti',1,1),
	...
	elsku barnið mitt, (elsku barnið mitt)',4,4),
	('The Little People',315,'enginn texti',1,1),
	('The Imperial March',183,'enginn texti',1,1),
	('Yoda´s Theme',195,'enginn texti',1,1),
	...
	Came and took my little girl away',5,5),
	...
	Down to the river 
	my baby and I 
	Oh down to the river we ride',5,5),
	('Parade Of The Ewoks',227,'enginn texti',1,1),
	...
	núna sefur dvergaþjóð.',4,4),
	('The Asteroid Field',274,'enginn texti',1,1),
	('Luke And Leia',299,'enginn texti',1,1),
	('The Cantina Band',136,'enginn texti',1,1),
	...
	I know the judge, I´ma shoot him some chips
	I got the keys, the keys, the keys
	I got the keys, the keys, the keys',3,3),
	...
	Another one
	Bless up',3,3),
	('Here They Come!',136,'enginn texti',1,1),
	('Jabba The Hutt',187,'enginn texti',1,1),
	('The Forset Battle',260,'enginn texti',1,1),
	('Throne room and finale',477,'enginn texti',1,1),
	...
	Everybody know me
	Everybody know me
	Everybody know Marshmello',2,2),
	('Summer',233,'enginn texti',2,2),
	('Find Me',180,'enginn texti',2,2);
...
#O
select distinct flytjandi.nafn as 'Flytjandi', lag.nafn as 'Fag', flytjandi.faedingardagur from lag
inner join flytjandi
on flytjandi.ID=lag.flytjandi_ID
limit 15 ;
